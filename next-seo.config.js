...
export default {
  title: 'Charles Awuku – Full Stack Developer',
  description:
    'Official portfolio of Charles Awuku – Full Stack Developer building enterprise-grade web & mobile apps using React, Next.js,React Native, Supabase, Firebase, Node.js and more.',
  canonical: siteUrl,
  openGraph: {
    type: 'website',
    locale: 'en_US',
